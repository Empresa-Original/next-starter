...
const SectionFive = (props: { layoutStyle: string }) => {
  return (
    <div className="relative">
      ...
      <div className="container mx-auto py-12">
        <div className={`flex justify-${props.layoutStyle === "center" ? "center text-center" : "start"}`}>
          <div className={`relative z-10 flex w-6/12 flex-col ${props.layoutStyle === 'center' ? 'items-center' : ''}`}>
